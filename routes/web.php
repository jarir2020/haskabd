...
Route::get('/admin', fn() => redirect()->route('login'), 301);

// Login / Logout routes -- moved from vendor/laravel/ui 2026-05-07
Route::get('mypanel',  [LoginController::class, 'showLoginForm'])->name('login');
Route::post('mypanel', [LoginController::class, 'login']);
...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    Route::get('products/hot-deals', [ProductController::class,'hotDeals'])->name('products.hot_deals');
    Route::get('products/flash-sales', [ProductController::class,'flashSales'])->name('products.flash_sales');
    Route::post('products/toggle-hot-deal', [ProductController::class,'toggleHotDeal'])->name('products.toggle_hot_deal');
    Route::post('products/toggle-flash-sale', [ProductController::class,'toggleFlashSale'])->name('products.toggle_flash_sale');
    Route::post('products/update-deals', [ProductController::class,'update_deals'])->name('products.update_deals');
    Route::post('products/update-flash-sales', [ProductController::class,'update_flash_sales'])->name('products.update_flash_sales');
    ...
    // Inventory -- added 2026-05-07
    Route::get('inventory/products',              [InventoryController::class,'products'])->name('admin.inventory.products');
    Route::get('inventory/profit',                [InventoryController::class,'profit'])->name('admin.inventory.profit');
    Route::get('inventory/tools',                 [InventoryController::class,'tools'])->name('admin.inventory.tools');
    Route::post('inventory/products/update',      [InventoryController::class,'update'])->name('admin.inventory.update');
    Route::post('inventory/products/import',      [InventoryController::class,'import'])->name('admin.inventory.import');
    Route::get('inventory/products/export',       [InventoryController::class,'export'])->name('admin.inventory.export');
    Route::get('inventory/products/sample',       [InventoryController::class,'sample'])->name('admin.inventory.sample');
    Route::post('inventory/products/bulk-delete', [InventoryController::class,'bulkDelete'])->name('admin.inventory.bulk_delete');
    Route::get('inventory/products/bulk-export',  [InventoryController::class,'bulkExport'])->name('admin.inventory.bulk_export');
    Route::post('inventory/notes/save',           [InventoryController::class,'saveNote'])->name('admin.inventory.notes.save');

    // Customer Reviews -- 2026-05-08
    Route::get('customer-reviews',              [CustomerReviewController::class,'index'])->name('admin.customer_reviews.index');
    Route::post('customer-reviews',             [CustomerReviewController::class,'store'])->name('admin.customer_reviews.store');
    Route::post('customer-reviews/{id}/toggle', [CustomerReviewController::class,'toggleStatus'])->name('admin.customer_reviews.toggle');
    Route::post('customer-reviews/{id}/delete', [CustomerReviewController::class,'destroy'])->name('admin.customer_reviews.destroy');
