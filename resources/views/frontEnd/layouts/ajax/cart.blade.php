...
<table class="cart_table table table-bordered table-striped text-center mb-0">
        ...
        <tbody>
         @php
             $cartIds = Cart::instance('shopping')->content()->pluck('id')->unique()->toArray();
             $cartProducts = \App\Models\Product::with('sizes','colors')->whereIn('id', $cartIds)->get()->keyBy('id');
         @endphp
         @foreach(Cart::instance('shopping')->content() as $value)
         @php $product = $cartProducts->get($value->id); @endphp
         <tr>
          <td>
