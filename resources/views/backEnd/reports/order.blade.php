                            ...
                            ">
                                <tr>
                                    <td>
                                        ...
                                        <h5><strong>Gross Sales = {{ $page_sales }}</strong></h5>
                                        <h5><strong>Discount = {{ $page_discount }}</strong></h5>
                                        <h5><strong>Net Sales = {{ $page_sales - $page_discount }}</strong></h5>
                                        <h5><strong>Purchase = {{ $page_purchase }}</strong></h5>
                                        <h5><strong>Profit = {{ ($page_sales - $page_discount) - $page_purchase }}</strong></h5>
                                    </td>
                                </tr>
                            </table>
                        </div>
