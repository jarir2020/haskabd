            ...
            <ul id="side-menu">
              ...
              <li>
                ...
                <div class="collapse" id="siebar-product">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('products.hot_deals')}}"><i data-feather="trending-up"></i> Hot Deals</a>
                    </li>
                    <li>
                      <a href="{{route('products.flash_sales')}}"><i data-feather="zap"></i> Flash Sales</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="sidebar-inventory">
                  <ul class="nav-second-level">
                    <li>
                      <a href="{{route('admin.inventory.products')}}"><i data-feather="layers"></i> Product Inventory</a>
                    </li>
                    <li>
                      <a href="{{route('admin.inventory.profit')}}"><i data-feather="trending-up"></i> Profit Calculation</a>
                    </li>
                    <li>
                      <a href="{{route('admin.inventory.tools')}}"><i data-feather="tool"></i> Inventory Tools</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-banner">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('admin.customer_reviews.index')}}"><i data-feather="image"></i> Customer Reviews</a>
                    </li>
                  </ul>
                </div>
              </li>
